...
namespace TopDownShooter
{
    public class CameraController : MonoBehaviour
    {
        ...
        {
            _cameraTransform.position= Vector3.Lerp(_cameraTransform.position, _targetTransform.position + _cameraSettings.PositionOffset, _cameraSettings.PositionLerp * Time.deltaTime);
        }
